    ...
    <Card className="p-6 border-[#E6E2D8] hover:border-gray-400 shadow-2xs hover:shadow-md transition-all duration-200 flex flex-col md:flex-row md:items-center justify-between gap-5 group">
      <div className="space-y-2 max-w-2xl">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <Badge
            variant={
              policy.category === "Academic"
                ? "academic"
                : policy.category === "Campus"
                ? "campus"
                : policy.category === "Exams"
                ? "exams"
          ...
          <Badge variant="outline" className="font-mono text-[11.5px] border-gray-300 bg-gray-100/90 text-gray-800 font-semibold">
            {policy.audience}
          </Badge>
        </div>
